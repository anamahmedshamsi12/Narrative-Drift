...
Narrative Drift: Tracking the Evolution of Social Media Narratives Using AI & Network Analysis is a local Python project that analyzes how social media narratives evolve over time. It clusters posts into narratives, builds a user-to-narrative graph, and provides a Streamlit dashboard for exploration.
